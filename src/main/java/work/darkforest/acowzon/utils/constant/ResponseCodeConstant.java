...
public class ResponseCodeConstant {
    ...
    public static final RetCode USER_ADDRESS_UPDATE_FAILED = RetCode.mark(20106, "用户默认地址修改失败");
    ...
    public static final RetCode USER_CANT_FIND_ADDRESS = RetCode.mark(20110, "找不到地址信息");
    ...
    public static final RetCode ADDRESS_CANT_FIND_USER = RetCode.mark(20205, "找不到对应的用户信息");
    ...
    public static final RetCode GOODS_UPDATE_FAILED = RetCode.mark(20404, "商品信息修改失败");
    public static final RetCode GOODS_DELETE_FAILED = RetCode.mark(20405, "商品删除失败");
    public static final RetCode GOODS_CANT_FIND_TYPE = RetCode.mark(20406, "未搜索到商品类别");
    public static final RetCode GOODS_CANT_FIND_USER = RetCode.mark(20407, "未搜索到用户信息");
    public static final RetCode GOODS_USER_IS_NOT_RETAILER = RetCode.mark(20408, "卖家身份不正确");
    ...
    public static final RetCode ORDER_BUYER_NOT_FIND = RetCode.mark(20509, "找不到买家信息");
    public static final RetCode ORDER_BUYER_TYPE_ERROR = RetCode.mark(20510, "买家的用户类型错误");
    public static final RetCode ORDER_RETAILER_NOT_FIND = RetCode.mark(20511, "卖家信息不存在");
    public static final RetCode ORDER_RETAILER_TYPE_ERROR = RetCode.mark(20511, "卖家的用户类型错误");
}
